...
class ActionProduct extends Component {
  ...
  handleChange = (event) => {
    ...
    const detail_info = target.detail_info
    this.setState({
      [name]: value
    });
  }
  ...
  handleSubmit = async (event) => {
    ...
    const {files, dataGallery, nameProduct, price, numberAvailable, categoryId, isActive, desc, properties, producerId, detail_info } = this.state;
    ...
    const newDetailInfo = detail_info;
    let newGalleryFinal = [];
  ...
  render() {
    const { dataGallery, nameProduct, loading, price,detail_info, numberAvailable, categoryId, isActive, image, desc, producerId, redirectToProduct, dataCategories, dataProducer } = this.state;
    let files;
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <form className="form-horizontal" onSubmit={(event) => this.handleSubmit(event)} >
                      ...
                      <div className="line" />  
                      <div className="form-group row">
                        <label className="col-sm-3 form-control-label">Detail info</label>
                        <div className="col-sm-9">
                          <input name="detail_info" onChange={this.handleChange} value={detail_info} type="text" className="form-control" />
                        </div>
                      </div>
                      <div className="line" />
                      <div className="form-group row">
