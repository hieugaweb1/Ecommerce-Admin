...
class ActionProducer extends Component {
  ...
  handleSubmit = async (event) => {
    ...
    const { isActive, name, desc, address, categoryId, country } = this.state;
    ...
    const newCountry = country === '' ? null : country
  ...
  render() {
    const { isActive, name, desc, address, redirectToProducer, dataCategories, categoryId, loading, image, country } = this.state;
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <form className="form-horizontal" onSubmit={(event) => this.handleSubmit(event)} >
                      ...
                      <div className="form-group row">
                        <label className="col-sm-3 form-control-label">country</label>
                        <div className="col-sm-9">
                          <input name="country" onChange={this.handleChange} value={country} type="text" className="form-control" />
                        </div>
                      </div>
                      <div className="line" />
                      <div className="form-group row">
